    ...
    public class clsInternationalLicenseData
    {
        ...
        public static DataTable GetAllInternationalLicenses()
        {
            ...
            string query = @"select  InternationalLicenseID,ApplicationID,DriverID,
                          ...
                          from InternationalLicenses order by IsActive ,ExpirationDate";
        ...
        public static int AddNewInternationalLicense(int ApplicationID,int DriverID,
            int IssuedUseingLocalDrivingLicenseID,DateTime IssueDate,DateTime ExpirationDate,
            bool IsActive,int CreatedByUserID)
        {
            ...
            command.Parameters.AddWithValue("@DriverID", DriverID);
            command.Parameters.AddWithValue("@IssuedUsingLocalLicenseID",IssuedUseingLocalDrivingLicenseID);
        ...
        public static bool UpdateInternationalLicense(int InternationalLicenseID,int ApplicationID,
            int DriverID,int IssuedUseingLocalDrivingLicenseID,DateTime IssueDate,
